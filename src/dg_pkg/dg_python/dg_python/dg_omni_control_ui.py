...
class DGButtonController(Node):
    ...
    def __init__(self):
        ...
        # 声明并获取 ROS2 参数 lo
        self.declare_parameter('lo', 20.000)
        self.lo = self.get_parameter('lo').get_parameter_value().double_value
        ...
        # 声明并获取 ROS2 参数 speed_dps
        self.declare_parameter('speed_dps', 2000.0)
        self.speed_dps = self.get_parameter('speed_dps').get_parameter_value().double_value
        # 安全限幅（可选）
