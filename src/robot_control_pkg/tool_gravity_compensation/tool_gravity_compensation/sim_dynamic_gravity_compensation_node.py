...
class SimDynamicGravityCompensationNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('link_masses', [0.01707, 0.065358, 0.099171, 0.88511])
        self.declare_parameter('link_com_x', [-0.00034904, 3.1503e-15, -0.00057962, 0.0002913455])
        self.declare_parameter('link_com_y', [0.00034904, 0.0, -0.00051221, 0.000318296])
        self.declare_parameter('link_com_z', [-6.9694e-05, 0.01886, -0.0055231, -0.00323911])
