...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('current_pose_topic', default_value='/gazebo/ee_pose'),
        ...
        DeclareLaunchArgument('tf_wait_timeout_sec', default_value='0.2'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'tf_wait_timeout_sec': LaunchConfiguration('tf_wait_timeout_sec'),
