...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "camera_names",
                default_value="['camera_fixed', 'camera_targetbody']",
                description="String list of camera names for multi-camera rendering.",
            ),
            DeclareLaunchArgument(
                "depth_near",
                default_value="0.1",
            ...
            # ========== 相机可视化节点参数 ==========
            DeclareLaunchArgument(
                "use_camera_visualizer",
                default_value="true",
                description="Whether to launch the camera visualizer node.",
            ),
            DeclareLaunchArgument(
                "show_depth",
                default_value="false",
                description="Whether to display depth images in the camera visualizer.",
            ),
                ...
                parameters=[
                    {
                        ...
                        "camera_names": ParameterValue(camera_names, value_type=str),
            ...
            Node(
                ...
                output="screen",
                condition=IfCondition(use_camera_visualizer),
                parameters=[
                    {
                        "camera_name": camera_name,
                        "camera_names": "camera_fixed,camera_targetbody",
