...
def test_v4_requires_three_joint_states_like_v2():
    assert has_required_joint_states(4, True, True, True)
    assert not has_required_joint_states(4, True, True, False)
