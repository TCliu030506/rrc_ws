...
protected:
  ...
  Vector6d admittance_displacement_limit_;        // 工具坐标系导纳位移限幅，防止补偿量无限累积
  Vector6d admittance_twist_limit_;               // 工具坐标系导纳速度限幅，防止接触瞬态速度过大
  ...
  void limit_admittance_state(); // 对虚拟导纳位移和速度做逐轴限幅
