...
def main(args=None):
    ...
    rtde_io_ = RTDEIO("192.168.1.102")
    rtde_receive_ = RTDEReceive("192.168.1.102")
    ...
    if rtde_receive_.getDigitalOutState(7):
     ...
     # 工具DO的0和1分别对应rtde_receive_.getDigitalOutState(16)和rtde_receive_.getDigitalOutState(17)
    if rtde_receive_.getDigitalOutState(16):
        print("Tool digital out (16) is HIGH")
    else:
        print("Tool digital out (16) is LOW")
