...
class FrameMotionFromTfNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter('velocity_filter_tau', 0.01)
        self.declare_parameter('accel_filter_tau', 0.05)
        self.declare_parameter('max_linear_speed', 10.0)
        self.declare_parameter('max_angular_speed', 20.0)
        self.declare_parameter('max_linear_accel', 30.0)
        self.declare_parameter('max_angular_accel', 80.0)
