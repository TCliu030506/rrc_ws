...
WAYJOINTS = [
    ...
    # 绕Wrist1旋转
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*2/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*1/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*5/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*6/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*7/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI/2],
    # 绕Wrist2旋转
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*3/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*2/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*1/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*5/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*6/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI*7/8, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI/2],
    # 绕Wrist3旋转
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*3/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*2/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*1/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*5/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*6/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI*7/8],
    [-PI/2, -PI/2, -PI/2, -PI/2, PI/2, -PI/2],

    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI/2],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*3/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*2/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*1/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*5/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*6/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI*7/8],
    [-PI/2, -PI/2, -PI/2, -PI*3/8, PI/2, -PI/2],
